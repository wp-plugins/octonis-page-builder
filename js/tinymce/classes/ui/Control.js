...
define("tinymce/ui/Control", [
	...
	var Control = Class.extend({
		...
		initLayoutRect: function() {
			...
			/*OCTO*/
			//console.log(self);
			if(settings.role == 'application' && self._parent) {
				//settings.x = self.rootControl.layoutRect().x;
				//settings.width = initialSize.width = self.rootControl.layoutRect().w;
			}
			/*****/
		...
		layoutRect: function(newRect) {
			...
			// Set new rect values
			if (newRect) {
				/*console.log('repaint', self._id, newRect.y);
				console.trace();*/
