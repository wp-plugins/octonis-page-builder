...
define("tinymce/ui/MenuButton", [
	...
	var MenuButton = Button.extend({
		...
		showMenu: function() {
			...
			/*OCTO*/
			//self._afterShowHide(true);
			/*****/
			
			//self.menu.layoutRect({w: self.layoutRect().w});
			/*OCTO*/
			//var reqX = self.menu.layoutRect().x;
			self.menu.moveRel(self.getEl(), self.isRtl() ? ['br-tr', 'tr-br'] : ['bl-tl', 'tl-bl']);
			self.menu.show();
			//self.menu.moveTo(reqX, self.menu.layoutRect().y);	// Move it all to left side of parrent panel
			/*****/
		},
		/*OCTO*/
		/*_afterShowHide: function(show) {
			...
			,	dY = self.menu._octSlimScrollH ? self.menu._octSlimScrollH : self.menu.layoutRect().h;
			if(show) {
				dY *= -1;
			}
			self.rootControl.moveBy(0, dY);
		},*/
		/*****/
		/**
